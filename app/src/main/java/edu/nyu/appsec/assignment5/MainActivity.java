...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // I get a lint warning on this line, but when I remove it the required javascript
        // functionality in the app, such as the menu, doesn't work.  Keeping.  Suppress Warning
